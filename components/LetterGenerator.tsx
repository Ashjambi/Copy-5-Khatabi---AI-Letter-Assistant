                                        ...
                                        {strategyAnalysis.paths.map((path) => (
                                            ...
                                            >
                                                <div>
                                                    ...
                                                    <p className="text-[10px] text-slate-500 font-medium italic opacity-0 group-hover:opacity-100 transition-all leading-relaxed">"{path.logic}"</p>
                                                </div>
                             ...
                             <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                {(['neutral', 'strict', 'diplomatic'] as const).map(vKey => (
                                    <div key={vKey} className="bg-slate-900/80 rounded-[2.2rem] border border-white/5 overflow-hidden flex flex-col hover:border-indigo-500/50 transition-all shadow-xl hover:-translate-y-1">
                                        ...
                                        <div className="p-6 flex-grow text-white text-[13px] leading-relaxed font-bold overflow-y-auto max-h-[400px] text-right prose prose-invert prose-sm custom-scrollbar" dangerouslySetInnerHTML={{ __html: sanitizeHTML(generatedContent.variations[vKey]) }} />
